"""
Copy from: https://github.com/fabiodimarco/torch-levenberg-marquardt/blob/main/src/torch_levenberg_marquardt/training.py
"""
...
from torch_levenberg_marquardt.tree import tree_cat, tree_first_tensor, tree_slice, tree_unsqueeze
...
class LevenbergMarquardt(Optimizer):
    ...
    def __init__(
        ...
        # print("LM.__init__ flat_params.shape", self.flat_params.shape)
        # print("LM.__init__ params.shape", next(iter(self._params)).shape)
    ...
    def _solve(self, matrix: Tensor, rhs: Tensor) -> Tensor:
        ...
        # return torch.linalg.lstsq(matrix, rhs)
    ...
    def _compute_jacobian(
        ...
        def compute_residuals(flat_params: Tensor) -> Tensor:
            ...
            # print("compute_residual flat_params.size", flat_params.size())
            # print("compute_residual flat_params type", type(flat_params))
            # print("compute_residual flat_params num_el", flat_params.numel())
            # print("compute_residual _params.size", next(iter(self._params)).size())
        ...
        # print("LM compute_jacobian outputs", outputs.shape)
