import subprocess
import sys
from .generate import save_multiple_samples, construct_template_variables
...
def save_videos(num_dump_step, all_text, all_lengths, all_motions, args, kframes, captions, obs_list, target, show_target_pose):
    sample_files = []
