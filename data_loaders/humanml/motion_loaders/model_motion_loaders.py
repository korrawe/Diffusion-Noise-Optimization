...
from data_loaders.humanml.motion_loaders.comp_v6_model_dataset import (CompMDMGeneratedDataset, 
                                                                       ...
                                                                       CompGeneratedDatasetPoseCondition, 
...
# Our loader for conditioning
def get_pose_cond_loader(args, model_dict, diffusion_dict, batch_size, ground_truth_loader,
                   mm_num_samples, mm_num_repeats, max_motion_length,
                   num_samples_limit, scale, seed, save_dir, noise_opt_conf):
    # set seed individually for each call
    fixseed(seed)
    opt = {
        'name': 'test',  # FIXME
    ...
    dataset = CompGeneratedDatasetPoseCondition(args, model_dict, diffusion_dict, ground_truth_loader,
                                      mm_num_samples, mm_num_repeats,
                                      max_motion_length, num_samples_limit,
                                      scale, save_dir=save_dir,
                                      seed=seed, noise_opt_conf=noise_opt_conf)
