...
class EvaluationOptions:
    ...
    eval_project_num_joints: str = field(
        default='all',
        metadata={
            "help":
            "Project the generated motion to the specified number of joints. If empty, will not project.",
            "choices": ['all', 'three', 'five', 'lower']
        })
    eval_project_noisy_target: bool = field(
        default=True,
        metadata={
            "help":
            "If True, will project the noisy target instead of the generated motion."
        })
